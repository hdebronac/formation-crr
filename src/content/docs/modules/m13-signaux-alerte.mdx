...
description: "Radiobalise de localisation des sinistres, balise personnelle, répondeur radar SART, AIS-SART, MOB-AIS, AIS et système Cospas-Sarsat."
sidebar:
  order: 13
---
...
<Aside type="note" title="Cadre">
  **Épreuve** : **C** — 10 questions sur 24 · **Volume** : 2,5 h ·
...
- *(rattachement à l'épreuve C et poids de cette épreuve)*
...
```
FORMATION CRR — M13 — Carte de cockpit
=======================================
