...
description: "Alphabet phonétique international, prononciation normalisée des lettres et des chiffres, signaux de base du vocabulaire normalisé de l’OMI."
sidebar:
  order: 5
---
...
- *(rattachement à l'épreuve A et poids de cette épreuve)*
