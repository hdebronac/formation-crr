...
description: "NAVTEX, SafetyNET, avis urgents aux navigateurs, bulletins météorologiques spéciaux, catégories de messages non rejetables."
sidebar:
  order: 12
---
...
<Aside type="note" title="Cadre">
  **Épreuve** : **C** — 10 questions sur 24 · **Volume** : 1,5 h ·
...
```
FORMATION CRR — M12 — Carte de cockpit
=======================================
